...
public class Highlight {
  ...
  private static final Integer LONG_TERM_BREAKPOINT =
      Integer.parseInt(Configuration.get("statistics.highlight.long_term_breakpoint"));
  private static final Integer MID_TERM_BREAKPOINT =
      Integer.parseInt(Configuration.get("statistics.highlight.mid_term_breakpoint"));
  private static final Integer QUICK_WIN_BREAKPOINT =
      Integer.parseInt(Configuration.get("statistics.highlight.quick_wins_breakpoint"));
  ...
  public Highlight(
      String title, String useCaseTitle, String description, Integer findings, HighlightType type) {
    this.title = title;
    this.type = type;

...
public class GroupingUtilsController {
    ...
    /**
     * Group architectures in the selected applications
     * @param neo4jAL Neo4j Access Layer
     * @param applications List of applications to process
     * @return The list of created architecture nodes
     * @throws Neo4jQueryException
     */
    public static List<Node> groupArchitectureSelectedApplication(Neo4jAL neo4jAL, List<String> applications)
            throws Neo4jQueryException {
        List<Node> res = new ArrayList<>();

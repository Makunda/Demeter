...
public class BackupController {
    ...
    public static List<Node> undoLevelGroup(Neo4jAL neo4jAL, String applicationContext) throws Neo4jBadRequestException, Neo4jQueryException, Neo4jNoResult, Neo4jBadNodeFormatException {
        List<Level5Node> backupedNodes = new ArrayList<>();
        ...
        for(Level5Node level : Level5Node.getAllNodesByApplication(neo4jAL, applicationContext)) {
            ...
            // If the fullname match, the level was generated by Demeter
        ...
        for(BackupNode bkn : backupNodeList) {
            ...
            backupedNodes.add(Level5Node.fromNode(neo4jAL, n));
        }

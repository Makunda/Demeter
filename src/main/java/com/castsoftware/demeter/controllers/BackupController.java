...
public class BackupController {
     ...
     */
    public static List<Node> undoLevelGroups(Neo4jAL neo4jAL, String applicationContext) throws Neo4jBadRequestException, Neo4jQueryException, Neo4jNoResult, Neo4jBadNodeFormatException {
        ...
        // Get all  backup node
        List<BackupNode> backupNodeList = BackupNode.getApplicationBackupNode(neo4jAL, applicationContext, IMAGING_LEVEL_5_LABEL);
     ...
     * @throws Neo4jQueryException
     */
    public static List<Node> undoOneLevelGroup(Neo4jAL neo4jAL, String applicationContext, String levelName) throws Neo4jBadRequestException, Neo4jNoResult, Neo4jBadNodeFormatException, Neo4jQueryException {
        ...
        if(toTreat == null) {
            throw new Neo4jBadRequestException(String.format("No level with name '%s' found in the database.", levelName), ERROR_PREFIX + "UNDOO1");
        }
        ...
        for (Iterator<Relationship> it = toTreat.getNode().getRelationships(Direction.OUTGOING, aggregatesRelationship).iterator(); it.hasNext(); ) {
            ...
            for(Iterator<Relationship> bckIt = obj.getRelationships(Direction.INCOMING, backedUpRelationship).iterator(); bckIt.hasNext();) {

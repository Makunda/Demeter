...
public class StateManager {
     ...
     * @throws IOException
     */
    private static void saveDemeterLevel5Map(GZIPOutputStream gout, Neo4jAL neo4jAL, String applicationContext) throws Neo4jNoResult, IOException, Neo4jQueryException {
     ...
     * @throws Neo4jNoResult
     */
    public static void saveDemeterLevel5(Neo4jAL neo4jAL, String applicationContext, String saveName) throws Neo4jQueryException, Neo4jNoResult {
        Label objectLabel = Label.label(IMAGING_OBJECT_LABEL);
     ...
     */
    public static void saveStateToFile(Neo4jAL neo4jAL, File saveFile, String applicationName) throws IOException, Neo4jNoResult, Neo4jQueryException {

 ...
 * Neo4jBadNodeFormat
 */
public class Neo4jBadNodeFormat extends TaggingException {
    ...
    public Neo4jBadNodeFormat(String message, Throwable cause, String code) {
        super(MESSAGE_PREFIX.concat(message), cause, CODE_PREFIX.concat(code));
    }

    public Neo4jBadNodeFormat(String message,  String code) {
